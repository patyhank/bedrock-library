...
func init() {
	...
	world.RegisterItem(DoubleWoodenSlab{})
...
type DoubleWoodenSlab struct{}

func (DoubleWoodenSlab) EncodeItem() (name string, meta int16) {
	return "minecraft:double_wooden_slab", 0
}
